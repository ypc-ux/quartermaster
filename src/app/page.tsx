      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        <section className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
          <div className="flex gap-3">
            ...
            <input type="text" value={command} onChange={(e) => setCommand(e.target.value)} placeholder="What do you want to build?" className="flex-1 bg-transparent border-none text-white placeholder:text-slate-600 text-lg focus:outline-none" />
            <button className="px-6 py-3 rounded-lg bg-gold text-navy font-semibold hover:bg-gold/90 transition">Execute</button>
          </div>
        </section>
